						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Lab </label>

										<div class="col-sm-9">
											<input type="text" name="nama_lab" placeholder="Masukan Nama Lab" class="col-xs-10 col-sm-5" value="<?=(isset($id_lokasi['nama_lab']))?($id_lokasi['nama_lab']):'';?>" />
										</div>
									</div>
