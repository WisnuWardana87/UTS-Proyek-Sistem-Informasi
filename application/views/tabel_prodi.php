					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Data Prodi</h3>
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											foreach($id_prodi as $val){?>
												<tr>
													...
													<td><?=$val['jurusan'];?></td>
													<td><?=$val['fakultas'];?></td>
													<td><a href="<?=site_url('Silab/update_register_prodi/'.md5($val['id_prodi']))?>"><i class="ace-icon fa fa-pencil bigger-130"></i></a></td>
													<td><a href="<?=site_url('Silab/delete_prodi/'.($val['id_prodi']));?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');"><i class="ace-icon fa fa-trash-o bigger-130"></i></a></td>
												</tr>
											<?php } ?>
											<tbody>
											</tbody>
