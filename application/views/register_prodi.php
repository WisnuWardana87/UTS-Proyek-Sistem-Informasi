							...
							<div class="col-xs-12">
								...
								<input type="hidden" name="id_prodi" value="<?=(isset($id_prodi['id_prodi']))?md5($id_prodi['id_prodi']):'';?>">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nama_prodi" placeholder="Masukan Nama Prodi" class="col-xs-10 col-sm-5" value="<?=(isset($id_prodi['nama_prodi']))?($id_prodi['nama_prodi']):'';?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="jurusan" placeholder="Masukan Nama Jurusan" class="col-xs-10 col-sm-5" value="<?=(isset($id_prodi['jurusan']))?($id_prodi['jurusan']):'';?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="fakultas" placeholder="Masukan Nama Prodi" class="col-xs-10 col-sm-5" value="<?=(isset($id_prodi['fakultas']))?($id_prodi['fakultas']):'';?>" />
										</div>
									</div>
