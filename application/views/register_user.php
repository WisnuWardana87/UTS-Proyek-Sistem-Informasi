						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nama" placeholder="Masukan Nama Anda" class="col-xs-10 col-sm-5" value="<?=(isset($id_user['nama']))?($id_user['nama']):'';?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="password" placeholder="Masukan Password" class="col-xs-10 col-sm-5" value="<?=(isset($id_user['password']))?($id_user['password']):'';?>" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="jabatan" placeholder="Masukan Jabatan Anda" class="col-xs-10 col-sm-5" value="<?=(isset($id_user['jabatan']))?($id_user['jabatan']):'';?>" />
										</div>
									</div>
