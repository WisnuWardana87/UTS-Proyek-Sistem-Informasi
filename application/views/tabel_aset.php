										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											foreach($kode_aset as $val){?>
												<tr>
													...
													<td><a href="<?=site_url('Silab/update_register_aset/'.md5($val['kode_aset']))?>"><i class="ace-icon fa fa-pencil bigger-130"></i></a></td>
													<td><a href="<?=site_url('Silab/delete_aset/'.($val['kode_aset']));?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');"><i class="ace-icon fa fa-trash-o bigger-130"></i></a></td>
												</tr>
											<?php } ?>
											<tbody>
											</tbody>
